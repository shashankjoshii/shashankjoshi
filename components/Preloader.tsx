...
export function Preloader() {
  ...
  return (
    <div
      ref={root}
      aria-hidden
      className="preloader fixed inset-0 z-[80] flex items-end bg-ink-2 p-6 md:p-10"
    >
      <span
        ref={count}
        className="pre-fade display text-[22vw] leading-none text-cream tabular-nums md:text-[12vw]"
      >
        0%
      </span>
